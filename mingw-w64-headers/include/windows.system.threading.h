...
#ifdef WIDL_USING_WINDOWS_SYSTEM_THREADING_WORKITEMPRIORITY
#define WorkItemPriority __x_ABI_CWindows_CSystem_CThreading_CWorkItemPriority
#endif /* WIDL_USING__WINDOWS_SYSTEM_THREADING_WORKITEMPRIORITY */
#endif /* __cplusplus */
...
#ifdef WIDL_USING_WINDOWS_SYSTEM_THREADING_WORKITEMOPTIONS
#define WorkItemOptions __x_ABI_CWindows_CSystem_CThreading_CWorkItemOptions
#endif /* WIDL_USING__WINDOWS_SYSTEM_THREADING_WORKITEMOPTIONS */
#endif /* __cplusplus */
...
#endif
#ifdef WIDL_USING_WINDOWS_SYSTEM_THREADING_ITHREADPOOLSTATICS
...
#endif /* WIDL_USING__WINDOWS_SYSTEM_THREADING_ITHREADPOOLSTATICS */
#endif
...
#endif
#ifdef WIDL_USING_WINDOWS_SYSTEM_THREADING_ITHREADPOOLTIMER
...
#endif /* WIDL_USING__WINDOWS_SYSTEM_THREADING_ITHREADPOOLTIMER */
#endif
...
/*** IThreadPoolTimerStatics methods ***/
static FORCEINLINE HRESULT __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolTimerStatics_CreatePeriodicTimer(__x_ABI_CWindows_CSystem_CThreading_CIThreadPoolTimerStatics* This,__x_ABI_CWindows_CSystem_CThreading_CITimerElapsedHandler *handler,struct __x_ABI_CWindows_CFoundation_CTimeSpan period,__x_ABI_CWindows_CSystem_CThreading_CIThreadPoolTimer **timer) {
    return This->lpVtbl->CreatePeriodicTimer(This,handler,period,timer);
}
static FORCEINLINE HRESULT __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolTimerStatics_CreateTimer(__x_ABI_CWindows_CSystem_CThreading_CIThreadPoolTimerStatics* This,__x_ABI_CWindows_CSystem_CThreading_CITimerElapsedHandler *handler,struct __x_ABI_CWindows_CFoundation_CTimeSpan delay,__x_ABI_CWindows_CSystem_CThreading_CIThreadPoolTimer **timer) {
    return This->lpVtbl->CreateTimer(This,handler,delay,timer);
}
static FORCEINLINE HRESULT __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolTimerStatics_CreatePeriodicTimerWithCompletion(__x_ABI_CWindows_CSystem_CThreading_CIThreadPoolTimerStatics* This,__x_ABI_CWindows_CSystem_CThreading_CITimerElapsedHandler *handler,struct __x_ABI_CWindows_CFoundation_CTimeSpan period,__x_ABI_CWindows_CSystem_CThreading_CITimerDestroyedHandler *destroyed,__x_ABI_CWindows_CSystem_CThreading_CIThreadPoolTimer **timer) {
    return This->lpVtbl->CreatePeriodicTimerWithCompletion(This,handler,period,destroyed,timer);
}
static FORCEINLINE HRESULT __x_ABI_CWindows_CSystem_CThreading_CIThreadPoolTimerStatics_CreateTimerWithCompletion(__x_ABI_CWindows_CSystem_CThreading_CIThreadPoolTimerStatics* This,__x_ABI_CWindows_CSystem_CThreading_CITimerElapsedHandler *handler,struct __x_ABI_CWindows_CFoundation_CTimeSpan delay,__x_ABI_CWindows_CSystem_CThreading_CITimerDestroyedHandler *destroyed,__x_ABI_CWindows_CSystem_CThreading_CIThreadPoolTimer **timer) {
    return This->lpVtbl->CreateTimerWithCompletion(This,handler,delay,destroyed,timer);
}
#endif
#ifdef WIDL_USING_WINDOWS_SYSTEM_THREADING_ITHREADPOOLTIMERSTATICS
...
#endif /* WIDL_USING__WINDOWS_SYSTEM_THREADING_ITHREADPOOLTIMERSTATICS */
#endif
